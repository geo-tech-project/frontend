  ...
  ngOnInit() {
    ...
    this.submitForm = this.fb.group({
      formArray: this.fb.array([
        ...
        this.fb.group({
          option: [{value: 'data', readonly: true}, Validators.required],
        ...
        this.fb.group({
          startDate: ['2021-05-01', Validators.required],
          endDate: ['2021-07-31', Validators.required],
        }),
        // resolution
        this.fb.group({
        ...
        // cloud coverage
        this.fb.group({
          coverage: [20, Validators.required],
        }),
      ]),
    });
